...
@pytest.mark.test_energy_import_module6
def test_energy_import_module6(parse):
...
@pytest.mark.test_energy_create_class_module6
def test_energy_create_class_module6(parse):
...
@pytest.mark.test_energy_convert_loop_module6
def test_energy_convert_loop_module6(parse):
    # for rec in data:
...
@pytest.mark.test_energy_class_variables_module6
def test_energy_class_variables_module6(parse):
...
@pytest.mark.test_energy_get_energy_method_module6
def test_energy_get_energy_method_module6(parse):
...
@pytest.mark.test_energy_by_area_method_module6
def test_energy_by_area_method_module6(parse):
    # def get_data_by_area(self, rec_area=0):
    #     data = super().get_data_by_area("energy", rec_area)
...
@pytest.mark.test_energy_by_area_method_return_module6
def test_energy_by_area_method_return_module6(parse):
    # ...
...
@pytest.mark.test_energy_by_date_method_module6
def test_energy_by_date_method_module6(parse):
    # from datetime import date
    # def get_data_by_date(self, rec_date=date.today()):
    #     recs = super().get_data_by_date("energy", rec_date)
...
@pytest.mark.test_energy_by_date_method_return_module6
def test_energy_by_date_method_return_module6(parse):
    # ...
    #     return self._convert_data(recs)
...
@pytest.mark.test_energy_calculate_usage_method_module6
def test_energy_calculate_usage_method_module6(parse):
...
@pytest.mark.test_sensor_app_temp_info_by_area_module6
def test_sensor_app_temp_info_by_area_module6(parse):
        ...
        my_file.assign_().match(
            {
                ...
                "19_value_args_0_type": "Name",
                "19_value_args_0_id": "recs",
            }
        )
        .exists()
    )
...
@pytest.mark.test_sensor_app_temp_info_by_date_module6
def test_sensor_app_temp_info_by_date_module6(parse):
    # ...
    # recs = energy_data.get_data_by_date(test_date)
    # NOTE: print statements are not validated
    # print("House Humidity sensor records for date: {} = {}".format(test_date.strftime("%m/%d/%y"), len(recs)))
    # print("\tMaximum: {0}, Minimum: {1}, and Averrage: {2} energys".format(max(recs), min(recs), mean(recs)))
        ...
        my_file.assign_().match(
            {
                ...
                "21_value_args_0_type": "Call",
                "21_value_args_0_func_type": "Attribute",
                "21_value_args_0_func_value_type": "Name",
                "21_value_args_0_func_value_id": "energy_data",
                "21_value_args_0_func_attr": "get_data_by_date",
                "21_value_args_0_keywords_0_type": "keyword",
                "21_value_args_0_keywords_0_arg": "rec_date",
                "21_value_args_0_keywords_0_value_type": "Name",
                "21_value_args_0_keywords_0_value_id": "test_date"
            }
        )
        .exists()
    )
